...
const TemplateSelector = ({ selectedTemplate, onchange }) => {
    ...
    const templates = [
        ...
        },
        {
            id: "modern",
            name: "Modern",
            preview: "a clean modern resume format with clear sections and professional typography",
        },
        {
            id: "minimal-image",
            name: "Minimal Image",
            preview: "a clean minimal resume format with clear sections and professional typography",
        },
        {
            id: "minimal",
            name: "Minimal",
